...
(function ($) {
    ...
    $(document).ready(function(){	
		...
		$('.single-team.nine').on( "click", function(){
			$('.team-details.nine').toggleClass('active');
		});
		$('.single-team.ten').on( "click", function(){
			$('.team-details.ten').toggleClass('active');
		});
		$('.single-team.eleven').on( "click", function(){
			$('.team-details.eleven').toggleClass('active');
		});
		$('.single-team.twelve').on( "click", function(){
			$('.team-details.twelve').toggleClass('active');
		});
		$('.single-team.thirteen').on( "click", function(){
			$('.team-details.thirteen').toggleClass('active');
		});
		$('.single-team.fourteen').on( "click", function(){
			$('.team-details.fourteen').toggleClass('active');
		});
		$('.single-team.fifteen').on( "click", function(){
			$('.team-details.fifteen').toggleClass('active');
		});
		$('.single-team.sixteen').on( "click", function(){
			$('.team-details.sixteen').toggleClass('active');
		});
		$('.single-team.seventeen').on( "click", function(){
			$('.team-details.seventeen').toggleClass('active');
		});
		$('.single-team.eighteen').on( "click", function(){
			$('.team-details.eighteen').toggleClass('active');
		});
		$('.single-team.nineteen').on( "click", function(){
			$('.team-details.nineteen').toggleClass('active');
		});
		$('.single-team.twenty').on( "click", function(){
			$('.team-details.twenty').toggleClass('active');
		});
		$('.team-details .cross').on( "click", function(){
			$('.team-details.one, .team-details.two, .team-details.three, .team-details.four, .team-details.five, .team-details.six, .team-details.seven, .team-details.eight, .team-details.nine, .team-details.ten, .team-details.eleven, .team-details.twelve, .team-details.thirteen, .team-details.fourteen, .team-details.fifteen, .team-details.sixteen, .team-details.seventeen, .team-details.eighteen, .team-details.nineteen, .team-details.twenty').removeClass('active');
		});	
